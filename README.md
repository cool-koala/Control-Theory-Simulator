...
如果你只是控制理论读者、学生或者演示使用者，你**不需要**先会 Git，也不需要把“提 PR”当成使用门槛。你只需要打开网页、切换控制器、调参数、看响应曲线就够了。  
如果你读着读着觉得这个项目还有值得补充、修正或扩展的地方，我们也真诚欢迎你一起参与：可以提 issue，可以 fork，也可以直接提交 PR。  

**众人拾柴火焰高。**  
我们希望这个项目既是一个给读者直接使用的工具，也是一个能持续被大家一起完善的控制理论演示平台。
...
1. 先看“普通读者怎么用”
2. 如果你想本地运行，再看“本地运行”
3. 如果你想一起改进项目，再看“如何参与共建”
4. 如果你是维护者，再看“GitHub 提交与发布流程”
...
如果你愿意一起完善这个项目，我们非常欢迎。你可以按自己的熟悉程度选择最轻松的参与方式：
...
- 提 issue 反馈 bug
- 提 issue 建议新增控制器
- 提 issue 说明某个控制器的描述、公式或调参提示哪里不准确
- 提 issue 建议新增案例、课程场景、图表或文案说明

### 方式 2：小范围修改后发 PR

如果你会一点 Git 或前端，可以从这些改动开始：
...
这部分我专门写清楚，避免误导，也避免把“欢迎共建”和“必须会开发”混在一起。
...
这个项目的真实受众主要是控制理论读者，但这不意味着它只面向读者。  
我们同样欢迎开发者、教师、学生和爱好者一起共建，所以“欢迎 PR”这件事是明确成立的，只是我们不把它写成一种门槛。
